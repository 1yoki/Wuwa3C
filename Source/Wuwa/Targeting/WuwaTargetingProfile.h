...
public:
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Targeting|Gather", meta = (ClampMin = "1.0", Units = "cm"))
    float SearchRadius = 2500.f;

    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Targeting|Filter", meta = (ClampMin = "1.0", ClampMax = "180.0", Units = "deg"))
    float MaxAcquireAngleDegrees = 65.f;

    // Hard Lock 可以离开初始搜索范围，但超过该距离必须解除。
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Targeting|Filter", meta = (ClampMin = "1.0", Units = "cm"))
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Targeting|Visibility", meta = (ClampMin = "0.0", Units = "s"))
    float OcclusionGraceTime = 0.35f;

    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Targeting|Refresh", meta = (ClampMin = "0.01", Units = "s"))
