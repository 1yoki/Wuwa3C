...
public:
    ...
    bool Initialize(const UWuwaCameraProfile *InProfile, UWuwaTargetingComponent *InTargetingComponent, USpringArmComponent *InCameraBoom, UCameraComponent *InFollowCamera);
...
private:
    ...
    bool ComposeLockOnRigState(const FWuwaCameraModeConfig &ModeConfig, const FWuwaTargetContext &TargetContext, FWuwaCameraRigState &InOutRigState) const;

    APlayerController *GetLocalViewController() const;
    bool CalculateDesiredLockOnControlRotation(const FWuwaTargetContext &TargetContext, FRotator &OutControlRotation) const;

    bool ApplyLockOnControlRotation(const FWuwaCameraModeConfig &ModeConfig, const FWuwaTargetContext &TargetContext, float DeltaTime, float AuthorityAlpha) const;
    ...
    static FWuwaCameraRigState InterpolateRigState(const FWuwaCameraRigState &From, const FWuwaCameraRigState &To, float Alpha);
