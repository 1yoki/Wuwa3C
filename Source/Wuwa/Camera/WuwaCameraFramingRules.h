...
namespace WuwaCameraFramingRules
{
     ...
     * 敌人一侧看回玩家的错误稳定解。
     */
    WUWA_API bool CalculateHorizontalCombatAxisYaw(
     ...
     */
    WUWA_API bool CalculateCameraCombatAxisProjection(
        const FVector &PlayerPoint,
        const FVector &TargetPoint,
     ...
     */
    WUWA_API bool CalculateBoundedAngleCorrection(const FWuwaCameraAngleCorrectionInput &Input, float &OutCorrectedAngleDegrees);
}
